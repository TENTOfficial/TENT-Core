(function (global, factory) {
  ...
  // -------------------------------------
  buildTable((0, _jquery2.default)('#exampleTableLargeColumns'), 50, 50);

  // Example Bootstrap Table Toolbar
  // -------------------------------
  (function () {
    (0, _jquery2.default)('#exampleTableToolbar').bootstrapTable({
  ...
  (function () {
    ...
    (0, _jquery2.default)('#exampleTableEvents').on('all.bs.table', function (e, name, args) {
