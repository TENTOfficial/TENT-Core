(function (global, factory) {
  ...
  (function () {
    ...
    var createChart = function createChart(button) {
      var btn = button || (0, _jquery2.default)("#ecommerceChartView .chart-action").find(".active");
